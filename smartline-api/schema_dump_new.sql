...
\restrict KV4OXRlirnUtUbmbgGGnTMzQ2sTI3gsxt4AEYpUja8KoJR9qqR0sn5wJPehgbvY
...
--
-- Name: mlb_team_data; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.mlb_team_data (
    team_id smallint NOT NULL,
    league character varying(20),
    division character varying(20),
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    CONSTRAINT mlb_team_data_division_check CHECK (((division)::text = ANY ((ARRAY['East'::character varying, 'Central'::character varying, 'West'::character varying])::text[]))),
    CONSTRAINT mlb_team_data_league_check CHECK (((league)::text = ANY ((ARRAY['American'::character varying, 'National'::character varying])::text[])))
);


--
-- Name: TABLE mlb_team_data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.mlb_team_data IS 'MLB-specific team data';


--
-- Name: nba_team_data; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.nba_team_data (
    team_id smallint NOT NULL,
    nickname text,
    ...
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    CONSTRAINT nba_team_data_conference_check CHECK (((conference)::text = ANY ((ARRAY['East'::character varying, 'West'::character varying])::text[]))),
    CONSTRAINT nba_team_data_division_check CHECK (((division)::text = ANY ((ARRAY['Atlantic'::character varying, 'Central'::character varying, 'Southeast'::character varying, 'Northwest'::character varying, 'Pacific'::character varying, 'Southwest'::character varying])::text[])))
);


--
-- Name: TABLE nba_team_data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.nba_team_data IS 'NBA-specific team data';


--
-- Name: nfl_team_data; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.nfl_team_data (
    team_id smallint NOT NULL,
    head_coach text,
    team_owner text,
    created_at timestamp without time zone DEFAULT now(),
...
--
-- Name: TABLE nfl_team_data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.nfl_team_data IS 'NFL-specific team data (head coach, owner)';


--
-- Name: nhl_team_data; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.nhl_team_data (
    team_id smallint NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    CONSTRAINT nhl_team_data_conference_check CHECK (((conference)::text = ANY ((ARRAY['Eastern'::character varying, 'Western'::character varying])::text[]))),
    CONSTRAINT nhl_team_data_division_check CHECK (((division)::text = ANY ((ARRAY['Atlantic'::character varying, 'Metropolitan'::character varying, 'Central'::character varying, 'Pacific'::character varying])::text[])))
);


--
-- Name: TABLE nhl_team_data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.nhl_team_data IS 'NHL-specific team data';
...
--
-- Name: COLUMN team.coach; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.team.coach IS 'DEPRECATED: Use nfl_team_data.head_coach. Kept for backward compatibility.';


--
-- Name: COLUMN team.owner; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.team.owner IS 'DEPRECATED: Use nfl_team_data.team_owner. Kept for backward compatibility.';


--
-- Name: COLUMN team.stadium; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.team.stadium IS 'DEPRECATED: Use venue_id. Kept for backward compatibility.';
...
--
-- Name: soccer_team_data; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.soccer_team_data (
    team_id smallint NOT NULL,
...
--
-- Name: TABLE soccer_team_data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.soccer_team_data IS 'Soccer-specific team data';
...
COMMENT ON TABLE public.venue IS 'Sport-agnostic venue/stadium/arena data';


--
-- Name: v_mlb_teams; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_mlb_teams AS
 SELECT t.team_id,
    t.league_id,
    t.name,
    t.abbrev,
   ...
   FROM ((public.team t
     LEFT JOIN public.mlb_team_data mlb ON ((t.team_id = mlb.team_id)))
     LEFT JOIN public.venue v ON ((t.venue_id = v.venue_id)))
  WHERE (t.sport_id = 5);


--
-- Name: v_nba_teams; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_nba_teams AS
 SELECT t.team_id,
    t.league_id,
    t.name,
    t.abbrev,
    ...
    v.capacity AS venue_capacity
   FROM ((public.team t
     LEFT JOIN public.nba_team_data nba ON ((t.team_id = nba.team_id)))
     LEFT JOIN public.venue v ON ((t.venue_id = v.venue_id)))
  WHERE (t.sport_id = 3);


--
-- Name: v_nfl_teams; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_nfl_teams AS
 SELECT t.team_id,
    t.league_id,
    t.name,
    t.abbrev,
    ...
    v.roof_type
   FROM ((public.team t
     LEFT JOIN public.nfl_team_data nfl ON ((t.team_id = nfl.team_id)))
     LEFT JOIN public.venue v ON ((t.venue_id = v.venue_id)))
  WHERE (t.sport_id = 1);


--
-- Name: v_nhl_teams; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_nhl_teams AS
 SELECT t.team_id,
    t.league_id,
    t.name,
    t.abbrev,
    ...
    v.capacity AS venue_capacity
   FROM ((public.team t
     LEFT JOIN public.nhl_team_data nhl ON ((t.team_id = nhl.team_id)))
     LEFT JOIN public.venue v ON ((t.venue_id = v.venue_id)))
  WHERE (t.sport_id = 6);
...
--
-- Name: v_soccer_teams; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_soccer_teams AS
 SELECT t.team_id,
    t.league_id,
    t.name,
    t.abbrev,
    ...
    v.capacity AS venue_capacity
   FROM ((public.team t
     LEFT JOIN public.soccer_team_data soc ON ((t.team_id = soc.team_id)))
     LEFT JOIN public.venue v ON ((t.venue_id = v.venue_id)))
  WHERE (t.sport_id = ANY (ARRAY[7, 8, 9, 10, 11, 12, 13]));
...
--
-- Name: mlb_team_data mlb_team_data_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mlb_team_data
    ADD CONSTRAINT mlb_team_data_pkey PRIMARY KEY (team_id);


--
-- Name: nba_team_data nba_team_data_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nba_team_data
    ADD CONSTRAINT nba_team_data_pkey PRIMARY KEY (team_id);


--
-- Name: nfl_team_data nfl_team_data_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nfl_team_data
    ADD CONSTRAINT nfl_team_data_pkey PRIMARY KEY (team_id);


--
-- Name: nhl_team_data nhl_team_data_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nhl_team_data
    ADD CONSTRAINT nhl_team_data_pkey PRIMARY KEY (team_id);
...
--
-- Name: player player_external_player_id_sport_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.player
    ADD CONSTRAINT player_external_player_id_sport_id_key UNIQUE (external_player_id, sport_id);
...
--
-- Name: soccer_team_data soccer_team_data_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.soccer_team_data
    ADD CONSTRAINT soccer_team_data_pkey PRIMARY KEY (team_id);
...
--
-- Name: team team_external_team_key_sport_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.team
    ADD CONSTRAINT team_external_team_key_sport_id_key UNIQUE (external_team_key, sport_id);
...
ALTER TABLE ONLY public.venue
    ADD CONSTRAINT uq_venue_name_city_state UNIQUE (name, city, state_province);
...
--
-- Name: idx_mlb_team_data_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mlb_team_data_team_id ON public.mlb_team_data USING btree (team_id);


--
-- Name: idx_nba_team_data_conference; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_nba_team_data_conference ON public.nba_team_data USING btree (conference);


--
-- Name: idx_nba_team_data_division; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_nba_team_data_division ON public.nba_team_data USING btree (division);


--
-- Name: idx_nba_team_data_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_nba_team_data_team_id ON public.nba_team_data USING btree (team_id);


--
-- Name: idx_nfl_team_data_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_nfl_team_data_team_id ON public.nfl_team_data USING btree (team_id);


--
-- Name: idx_nhl_team_data_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_nhl_team_data_team_id ON public.nhl_team_data USING btree (team_id);
...
--
-- Name: idx_soccer_team_data_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_soccer_team_data_team_id ON public.soccer_team_data USING btree (team_id);
...
--
-- Name: idx_team_external_key_sport; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_team_external_key_sport ON public.team USING btree (external_team_key, sport_id);
...
--
-- Name: idx_team_venue_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_venue_city; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_venue_country; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_venue_country ON public.venue USING btree (country_code);


--
-- Name: idx_venue_external_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_venue_external_id ON public.venue USING btree (external_venue_id);


--
-- Name: idx_venue_name; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: mlb_team_data mlb_team_data_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mlb_team_data
    ADD CONSTRAINT mlb_team_data_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.team(team_id) ON DELETE CASCADE;


--
-- Name: nba_team_data nba_team_data_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nba_team_data
    ADD CONSTRAINT nba_team_data_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.team(team_id) ON DELETE CASCADE;


--
-- Name: nfl_team_data nfl_team_data_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nfl_team_data
    ADD CONSTRAINT nfl_team_data_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.team(team_id) ON DELETE CASCADE;


--
-- Name: nhl_team_data nhl_team_data_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nhl_team_data
    ADD CONSTRAINT nhl_team_data_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.team(team_id) ON DELETE CASCADE;
...
--
-- Name: soccer_team_data soccer_team_data_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.soccer_team_data
    ADD CONSTRAINT soccer_team_data_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.team(team_id) ON DELETE CASCADE;
...
--
-- Name: team team_venue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.team
    ADD CONSTRAINT team_venue_id_fkey FOREIGN KEY (venue_id) REFERENCES public.venue(venue_id) ON DELETE SET NULL;
...
\unrestrict KV4OXRlirnUtUbmbgGGnTMzQ2sTI3gsxt4AEYpUja8KoJR9qqR0sn5wJPehgbvY
